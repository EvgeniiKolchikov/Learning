...
public class SecondClass : AccessModifiersLesson
{
    public void Printlesson()
    {
        var sec = new SecondClass();

        //Console.WriteLine(sec.privateVar);

        Console.WriteLine(sec.protectedPrivateVar);

        Console.WriteLine(sec.protectedVar);
        Console.WriteLine(sec.internalVar);

        Console.WriteLine(sec.protectedInternalVar);

        Console.WriteLine(sec.publicVar);
        
        //sec.Print();
        sec.PrintProtectedPrivate();
        sec.PrintProtected();
        sec.PrintInternal();
        sec.PrintProtectedInternal();
        sec.PrintPublic();
...
public class LIbClass : Lib
{
    void d()
    {
        var t = ProtectedString;
        var r = ProtectedInternal;
    }
}